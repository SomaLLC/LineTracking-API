...
best_model_path = "/home/ubuntu/LineTracking-API/runs/detect/gato-nose-yolo"
...
if os.path.exists(best_model_path):
    ...
    for root, dirs, files in os.walk(best_model_path):
        for file in files:
            ...
            blob = bucket.blob(f'models/gato-nose-yolo/{relative_path}')
